...
def plot_overhead(df, ax, is_mem, title):
    ...
    ax.set_xlabel('Message Size (kbytes)')
    ax.grid(True)
...
if __name__ == '__main__':
    ...
    subtitle_hawk = f'Overhead on HAWK: Intra- and Inter-Node Comm.'
    ...
    subtitle_sng = f'Overhead on SNG: Intra- and Inter-Node Comm.'
