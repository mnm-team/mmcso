...
namespace mmcso
{
    ...
    public:
        ...
        friend int invoke(MpiCommand const &command, MPI_Request *request)
        {
            return command.pimpl()->do_invoke(request);
        }
    ...
    /**
     * @brief Creates a callable object
     *
     * @tparam Function
     * @tparam HasRequest
     * @param args
