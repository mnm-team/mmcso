...
{
    oe.post(OffloadCommand{make_mpi_callable<1, PMPI_Iallgather, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<2, PMPI_Iallgatherv, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcounts), std::move(displs), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<3, PMPI_Iallreduce, true>(std::move(sendbuf), std::move(recvbuf), std::move(count), std::move(datatype), std::move(op), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<4, PMPI_Ialltoall, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<5, PMPI_Ialltoallv, true>(std::move(sendbuf), std::move(sendcounts), std::move(sdispls), std::move(sendtype), std::move(recvbuf), std::move(recvcounts), std::move(rdispls), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<6, PMPI_Ialltoallw, true>(std::move(sendbuf), std::move(sendcounts), std::move(sdispls), std::move(sendtypes), std::move(recvbuf), std::move(recvcounts), std::move(rdispls), std::move(recvtypes), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<7, PMPI_Ibarrier, true>(std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<8, PMPI_Ibcast, true>(std::move(buffer), std::move(count), std::move(datatype), std::move(root), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<9, PMPI_Comm_idup, true>(std::move(comm), std::move(newcomm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<10, PMPI_Iexscan, true>(std::move(sendbuf), std::move(recvbuf), std::move(count), std::move(datatype), std::move(op), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<11, PMPI_File_iread_at, true>(std::move(fh), std::move(offset), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}

int MPI_File_iwrite_at(MPI_File fh, MPI_Offset offset, const void * buf, int count, MPI_Datatype datatype, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<12, PMPI_File_iwrite_at, true>(std::move(fh), std::move(offset), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}

int MPI_File_iread_at_all(MPI_File fh, MPI_Offset offset, void * buf, int count, MPI_Datatype datatype, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<13, PMPI_File_iread_at_all, true>(std::move(fh), std::move(offset), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<14, PMPI_File_iwrite_at_all, true>(std::move(fh), std::move(offset), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<15, PMPI_File_iread, true>(std::move(fh), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}

int MPI_File_iwrite(MPI_File fh, const void * buf, int count, MPI_Datatype datatype, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<16, PMPI_File_iwrite, true>(std::move(fh), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}

int MPI_File_iread_all(MPI_File fh, void * buf, int count, MPI_Datatype datatype, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<17, PMPI_File_iread_all, true>(std::move(fh), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}

int MPI_File_iwrite_all(MPI_File fh, const void * buf, int count, MPI_Datatype datatype, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<18, PMPI_File_iwrite_all, true>(std::move(fh), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<19, PMPI_File_iread_shared, true>(std::move(fh), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}

int MPI_File_iwrite_shared(MPI_File fh, const void * buf, int count, MPI_Datatype datatype, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<20, PMPI_File_iwrite_shared, true>(std::move(fh), std::move(buf), std::move(count), std::move(datatype)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<21, PMPI_Igather, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(root), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<22, PMPI_Igatherv, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcounts), std::move(displs), std::move(recvtype), std::move(root), std::move(comm)), request});
    return MPI_SUCCESS;
}

int MPI_Ibsend(const void * buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<23, PMPI_Ibsend, true>(std::move(buf), std::move(count), std::move(datatype), std::move(dest), std::move(tag), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
int MPI_Improbe(int source, int tag, MPI_Comm comm, int * flag, MPI_Message * message, MPI_Status * status)
{
    ...
    oe.post(OffloadCommand{make_mpi_callable<24, PMPI_Improbe, false>(std::move(source), std::move(tag), std::move(comm), std::move(flag), std::move(message), std::move(status)), &request_local});
    return MPI_SUCCESS;
}

int MPI_Imrecv(void * buf, int count, MPI_Datatype type, MPI_Message * message, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<25, PMPI_Imrecv, true>(std::move(buf), std::move(count), std::move(type), std::move(message)), request});
    return MPI_SUCCESS;
}
...
{
    MPI_Request request_local = MPI_REQUEST_NULL; // TODO
    oe.post(OffloadCommand{make_mpi_callable<26, PMPI_Iprobe, false>(std::move(source), std::move(tag), std::move(comm), std::move(flag), std::move(status)), &request_local});
    return MPI_SUCCESS;
}

int MPI_Irecv(void * buf, int count, MPI_Datatype datatype, int source, int tag, MPI_Comm comm, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<27, PMPI_Irecv, true>(std::move(buf), std::move(count), std::move(datatype), std::move(source), std::move(tag), std::move(comm)), request});
    return MPI_SUCCESS;
}

int MPI_Irsend(const void * buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<28, PMPI_Irsend, true>(std::move(buf), std::move(count), std::move(datatype), std::move(dest), std::move(tag), std::move(comm)), request});
    return MPI_SUCCESS;
}

int MPI_Isend(const void * buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<29, PMPI_Isend, true>(std::move(buf), std::move(count), std::move(datatype), std::move(dest), std::move(tag), std::move(comm)), request});
    return MPI_SUCCESS;
}

int MPI_Issend(const void * buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request * request)
{
    oe.post(OffloadCommand{make_mpi_callable<30, PMPI_Issend, true>(std::move(buf), std::move(count), std::move(datatype), std::move(dest), std::move(tag), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<31, PMPI_Ineighbor_allgather, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<32, PMPI_Ineighbor_allgatherv, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcounts), std::move(displs), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<33, PMPI_Ineighbor_alltoall, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<34, PMPI_Ineighbor_alltoallv, true>(std::move(sendbuf), std::move(sendcounts), std::move(sdispls), std::move(sendtype), std::move(recvbuf), std::move(recvcounts), std::move(rdispls), std::move(recvtype), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<35, PMPI_Ineighbor_alltoallw, true>(std::move(sendbuf), std::move(sendcounts), std::move(sdispls), std::move(sendtypes), std::move(recvbuf), std::move(recvcounts), std::move(rdispls), std::move(recvtypes), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<36, PMPI_Ireduce, true>(std::move(sendbuf), std::move(recvbuf), std::move(count), std::move(datatype), std::move(op), std::move(root), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<37, PMPI_Ireduce_scatter, true>(std::move(sendbuf), std::move(recvbuf), std::move(recvcounts), std::move(datatype), std::move(op), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<38, PMPI_Ireduce_scatter_block, true>(std::move(sendbuf), std::move(recvbuf), std::move(recvcount), std::move(datatype), std::move(op), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<39, PMPI_Iscan, true>(std::move(sendbuf), std::move(recvbuf), std::move(count), std::move(datatype), std::move(op), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<40, PMPI_Iscatter, true>(std::move(sendbuf), std::move(sendcount), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(root), std::move(comm)), request});
    return MPI_SUCCESS;
}
...
{
    oe.post(OffloadCommand{make_mpi_callable<41, PMPI_Iscatterv, true>(std::move(sendbuf), std::move(sendcounts), std::move(displs), std::move(sendtype), std::move(recvbuf), std::move(recvcount), std::move(recvtype), std::move(root), std::move(comm)), request});
    return MPI_SUCCESS;
}
